...
- I graduated from college and had more free time on my hands than a chimpanzee with a time turner.
...
In regards to digital minimalism, I had high aspirations for how I'd use technology, but it didn't matter because I didn't have the willpower (or something) to keep me from opening up some app from the pantheon of the attention economy.

![Frog and Toad eating cookies](./images/frog-and-toad.png)

A pointedly profound life lesson from 2 of literature's finest: Frog and Toad
...
Consider the fact that **the only** call to action (call to action meaning the thing you're being persuaded to do) on this screen is "Ignore Limit". The ONLY button. There's nowhere else the design is encouraging you to click except for the very one to bypass the protection you've set. It feels hollow, like Apple is showing an alcoholic out of a bar while dangling a bottle of cold ones in front of them at the same time.
...
One of my favorite card games (or game in general) is called [Dominion](https://en.wikipedia.org/wiki/Dominion_%28card_game%29). It's a deck building game where you start with some lousy cards, and have to use them to start buying up better and better cards to build a better deck. I think it has a lot of parallels with life and minimalism.
...
Rather than filling life with cards like a maximalist, I've found **it's worth it to consider giving some up** by trashing them so I can focus more on the stuff I care about. On any given day I can get another few minutes on Twitter, but I get a lot more out of things when I actually _remove_ Twitter from my deck.

## How the Digital Declutter Went
...
I started my digital detox on July 4th (I figured a fitting day to celebrate freedom), and didn't formally end on August 3rd when 30 days had passed because I didn't really feel much of a need to go back to old habits quite yet. A few days later I jumped on Twitter to find that the very first tweet I was recommended was a crass and kind of unsavory video. I subsequently closed Twitter and return every now and then to check messages and (sometimes) tweet myself. It's actually felt, dare I say it, rewarding.
